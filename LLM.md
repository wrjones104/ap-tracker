...
*   **Authentication:** Integrates with Discord OAuth2 using the `net.openid.appauth` library via native deep-linking schemes (`discord-<CLIENT_ID>://authorize/callback`).
